...
STYLE_PRESET = {'id': 'reggae',
 ...
 'style_prompts': {'small': 'Reggae with relaxed one-drop, rockers, or steppers '
                   ...
                   'large': 'Reggae with relaxed one-drop, rockers, or steppers '
                            ...
                            'melodic layers, and warm communal delivery. Use a 4/4 '
                            'framework around 78 BPM in A minor, with medium energy '
                            'and spacious, warm, resistant, spiritual mood. Build the '
                            'form through cyclic groove, main melodic line verse, '
 ...
 'voice_presets': {'default_gender': 'male',
                   'small': {'male': 'Natural male reggae lead with native diction, '
                             ...
                             'female': 'Natural female reggae lead with native '
                                       'diction, warm tone, easy phrasing, and clean '
                                       'releases.'},
                   'medium': {'male': 'Warm male lead vocal centered in a low '
                                      'speaking-register range, with relaxed vowels, '
                                      'clear consonants, and supported steady breath. '
                                      'Keep low notes audible and stable through '
                                      'chest-balanced.',
                              'female': 'Warm female low-register lead uses forward '
                                        'resonance and supported airflow to keep lower '
                                        'notes rounded, audible, and pitch-stable. '
                                        'Shape relaxed vowels with precise consonant '
                                        'edges, smooth phrase.'},
                   'large': {'male': 'Warm male lead vocal centered in a low '
                                     'speaking-register range, with relaxed vowels, '
                                     'clear consonants, and supported steady breath. '
                                     'Keep low notes audible and stable through '
                                     'chest-balanced resonance, calm phrase shaping, '
                                     'gentle intensity growth, and restrained vibrato '
                                     'through the final release.',
                             'female': 'Warm female low-register lead uses forward '
                                       'resonance and supported airflow to keep lower '
                                       'notes rounded, audible, and pitch-stable. '
                                       'Shape relaxed vowels with precise consonant '
                                       'edges, smooth phrase arcs, controlled sustain, '
                                       'and restrained vibrato near the final release '
                                       'while the tone stays low and unforced.'}}}
